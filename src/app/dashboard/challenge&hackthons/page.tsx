        ...
        <div className='flex flex-col gap-[20px] items-center px-4 h-full py-4 w-full'>
            ...
            <div className='md:flex grid grid-cols-1 sm:grid-cols-2 md:flex-row gap-[12px] w-full'>
                ...
                <LinkComponent
                    ...
                    number={challenge?.data?.filter((status:any)=> status.status == "complete")?.length} />
                <LinkComponent
                    ...
                    number={challenge?.data?.filter((status:any)=> status.status == "open")?.length} />
                <LinkComponent
                    ...
                    number={challenge?.data?.filter((status:any)=> status.status == "pending")?.length} />
            </div>
